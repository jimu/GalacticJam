...
public class PictureCorrection_RLPRO : ScriptableRendererFeature
{
    ...
    private PictureCorrection_RLPROPass PictureCorrectionRenderPass;
    public RenderPassEvent Event = RenderPassEvent.AfterRenderingPostProcessing;

    public override void Create()
    {
        m_Shader = Shader.Find("Hidden/Shader/PictureCorrectionEffect_RLPRO");
        if (m_Shader == null)
        {
            return;
        }
        material = new Material(m_Shader);
        PictureCorrectionRenderPass = new PictureCorrection_RLPROPass(material);

        PictureCorrectionRenderPass.renderPassEvent = Event;
    }

    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        PictureCorrection myVolume = VolumeManager.instance.stack?.GetComponent<PictureCorrection>();
        ...
        {
            renderer.EnqueuePass(PictureCorrectionRenderPass);
        }
    }
    ...
    public class PictureCorrection_RLPROPass : ScriptableRenderPass
	{
        ...
        public PictureCorrection_RLPROPass(Material material)
        {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            var volumeComponent = VolumeManager.instance.stack.GetComponent<PictureCorrection>();
			...
			material.SetFloat(signalAdjustY, volumeComponent.signalAdjustY.value);
			material.SetFloat(signalAdjustI, volumeComponent.signalAdjustI.value);
			material.SetFloat(signalAdjustQ, volumeComponent.signalAdjustQ.value);
			material.SetFloat(signalShiftY, volumeComponent.signalShiftY.value);
			material.SetFloat(signalShiftI, volumeComponent.signalShiftI.value);
			material.SetFloat(signalShiftQ, volumeComponent.signalShiftQ.value);
			material.SetFloat(gammaCorection, volumeComponent.gammaCorection.value);
