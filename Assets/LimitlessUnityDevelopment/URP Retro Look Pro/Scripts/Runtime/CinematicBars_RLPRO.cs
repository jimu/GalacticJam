...
public class CinematicBars_RLPRO : ScriptableRendererFeature
{
    ...
    private CinematicBars_RLPROPass CinematicBarsRenderPass;
    public RenderPassEvent Event = RenderPassEvent.AfterRenderingPostProcessing;

    public override void Create()
    {
        m_Shader = Shader.Find("Hidden/Shader/CinematicBarsEffect_RLPRO");
        if (m_Shader == null)
        {
            return;
        }
        material = new Material(m_Shader);
        CinematicBarsRenderPass = new CinematicBars_RLPROPass(material);

        CinematicBarsRenderPass.renderPassEvent = Event;
    }

    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        CinematicBars myVolume = VolumeManager.instance.stack?.GetComponent<CinematicBars>();
        ...
        {
            renderer.EnqueuePass(CinematicBarsRenderPass);
        }
    }
    ...
    public class CinematicBars_RLPROPass : ScriptableRenderPass
    {
        ...
        public CinematicBars_RLPROPass(Material material)
        {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            var volumeComponent = VolumeManager.instance.stack.GetComponent<CinematicBars>();

            material.SetFloat(_StripesV, 0.51f - volumeComponent.amount.value);
