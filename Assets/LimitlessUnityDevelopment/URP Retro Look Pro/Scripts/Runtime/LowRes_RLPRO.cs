...
public class LowRes_RLPRO : ScriptableRendererFeature
{
    ...
    private LowRes_RLPROPass LowResRenderPass;
    public RenderPassEvent Event = RenderPassEvent.AfterRenderingPostProcessing;

    public override void Create()
    {
        m_Shader = Shader.Find("Hidden/Shader/LowResolution_RLPRO");
        if (m_Shader == null)
        {
            return;
        }
        material = new Material(m_Shader);
        LowResRenderPass = new LowRes_RLPROPass(material);

        LowResRenderPass.renderPassEvent = Event;
    }

    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        LowRes myVolume = VolumeManager.instance.stack?.GetComponent<LowRes>();
        ...
        {
            renderer.EnqueuePass(LowResRenderPass);
        }
    }
    ...
    public class LowRes_RLPROPass : ScriptableRenderPass
	{
        ...
        public LowRes_RLPROPass(Material material)
        {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            var volumeComponent = VolumeManager.instance.stack.GetComponent<LowRes>();
			...
			material.SetInt(HeightV, (int)volumeComponent.height);
			material.SetInt(WidthV, Mathf.RoundToInt((int)volumeComponent.height * ratio));
