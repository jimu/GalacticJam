...
public class CustomTexture_RLPRO : ScriptableRendererFeature
{
    ...
    private CustomTexture_RLPROPass CustomTexture;
    public RenderPassEvent Event = RenderPassEvent.AfterRenderingPostProcessing;

    public override void Create()
    {
        m_Shader = Shader.Find("Hidden/Shader/CustomTextureEffect_RLPRO");
        if (m_Shader == null)
        {
            return;
        }
        material = new Material(m_Shader);
        CustomTexture = new CustomTexture_RLPROPass(material);

        CustomTexture.renderPassEvent = Event;
    }

    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        CustomTexture myVolume = VolumeManager.instance.stack?.GetComponent<CustomTexture>();
        ...
        {
            renderer.EnqueuePass(CustomTexture);
        }
    }
    ...
    public class CustomTexture_RLPROPass : ScriptableRenderPass
	{
        ...
        public CustomTexture_RLPROPass(Material material)
        {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            var volumeComponent = VolumeManager.instance.stack.GetComponent<CustomTexture>();
            if (volumeComponent.texture.value != null)
				material.SetTexture(_CustomTextureV, volumeComponent.texture.value);
