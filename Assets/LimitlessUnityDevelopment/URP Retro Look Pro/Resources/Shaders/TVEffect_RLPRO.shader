...
#pragma shader_feature ALPHA_CHANNEL
	...
	float3 Fetch(float2 pos, float2 off)
	{
		...
		return SAMPLE_TEXTURE2D_LOD(_BlitTexture, sampler_LinearClamp, pos.xy, float2(0, -16.0)).xyz;
	}
    ...
    float4 CustomPostProcessTVWarp(Varyings input) : SV_Target
    {
        ...
        float4 outColor = SAMPLE_TEXTURE2D(_BlitTexture, sampler_LinearClamp, positionSS);
		...
		fragColor.a = SAMPLE_TEXTURE2D(_BlitTexture, sampler_LinearClamp, pos).a;
