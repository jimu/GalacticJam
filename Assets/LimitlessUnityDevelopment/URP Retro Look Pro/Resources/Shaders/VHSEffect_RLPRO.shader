...
#pragma shader_feature ALPHA_CHANNEL
		...
		float4 FragDivide(Varyings1 input) : SV_Target
	{
		...
		col.r = SAMPLE_TEXTURE2D(_BlitTexture, sampler_LinearClamp, positionSS + (amount * half2(_OffsetColorAngle.y, _OffsetColorAngle.x))).r;
		col.b = SAMPLE_TEXTURE2D(_BlitTexture, sampler_LinearClamp, positionSS - (amount * half2(_OffsetColorAngle.y, _OffsetColorAngle.x))).b;
