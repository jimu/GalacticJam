...
#include "Packages/com.unity.render-pipelines.core/Runtime/Utilities/Blit.hlsl"
	...
	{
		 half2 positionSS = p  ;
		float3 outColor = SAMPLE_TEXTURE2D(_BlitTexture, sampler_LinearClamp, positionSS).xyz;
	...
	float4 CustomPostProcessNTSCOld3Phase(Varyings input) : SV_Target
	{
		...
		half4 col23 = SAMPLE_TEXTURE2D(_BlitTexture, sampler_LinearClamp, fixCoord  );
